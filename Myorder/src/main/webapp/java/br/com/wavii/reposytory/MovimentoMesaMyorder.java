...
public class MovimentoMesaMyorder implements Serializable {
	...
	public List<MovimentoMesa> filtrados(MovimentoMesaFilter filtro) {
		...
		if (StringUtils.isBlank((CharSequence) filtro.getTotalmesa())) {
			// acessamos o nome do cliente associado ao pedido pelo alias "c",
			// criado anteriormente
			criteria.add(Restrictions.ilike(sum, filtro.getTotalmesa(), MatchMode.ANYWHERE));
		}
