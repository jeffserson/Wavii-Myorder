...
import br.com.wavii.util.ExecutorRelatorio;
...
public class RelatorioPedidosEmitidosBean implements Serializable {
	...
	public void emitir() {
		...
		parametros.put("DATAINI", this.dataInicio);
		parametros.put("DATAFIM", this.dataFim);
		
		ExecutorRelatorio executor = new ExecutorRelatorio("/relatorios/movimentomesa.jasper",
